...
export const menuItems: MenuItem[] = [
  {
    ...
    description: 'Our signature burger with premium Angus beef, aged cheddar, lettuce, tomato, and our special craft sauce on a brioche bun.',
    price: 9.99,
  ...
  },
  {
    id: 2,
    name: 'Smokehouse BBQ',
    description: 'Smoked beef patty, bourbon BBQ sauce, crispy bacon, caramelized onions, and smoked gouda cheese on a pretzel bun.',
    price: 11.99,
  ...
  },
  {
    id: 3,
    name: 'Mushroom Swiss',
    description: 'Beef patty topped with sautéed forest mushrooms, Swiss cheese, arugula, and truffle aioli on a toasted bun.',
    price: 12.99,
  ...
  },
  {
    id: 4,
    name: 'Veggie Garden',
    description: 'House-made vegetable patty with avocado, sprouts, roasted red peppers, and herb aioli on a whole grain bun.',
    price: 10.99,
  ...
  },
  {
    ...
    description: 'Double beef patties, double bacon, double cheese with caramelized onions and special sauce on a brioche bun.',
    price: 18.99,
  ...
  },
  {
    id: 6,
    name: 'Spicy Jalapeño',
    description: 'Beef patty with pepper jack cheese, jalapeños, spicy mayo, and crispy fried onions on a toasted bun.',
    price: 14.99,
  ...
  },
  {
    id: 7,
    name: 'Truffle Fries',
    description: 'Hand-cut fries tossed in truffle oil, parmesan cheese, and fresh herbs.',
    price: 8.99,
  ...
  },
  {
    id: 9,
    name: 'Onion Rings',
    description: 'Thick-cut onions, beer-battered and fried to golden perfection, served with house dipping sauce.',
    price: 5.99,
  ...
  },
  {
    id: 10,
    name: 'Craft Soda',
    description: 'House-made artisanal sodas. Ask about our flavors of the day.',
    price: 5.99,
  ...
  },
  {
    id: 11,
    name: 'Milkshake',
    description: 'Creamy hand-spun milkshakes made with premium ice cream. Classic or specialty flavors available.',
    price: 7.99,
  ...
  },
  {
    ...
    description: 'Beef patty topped with spicy buffalo sauce, crumbled blue cheese, crispy onions, and celery slaw on a toasted bun.',
    price: 16.99,
  ...
  },
  {
    ...
    description: 'Seasoned lamb patty with feta cheese, cucumber, red onion, tzatziki sauce, and fresh mint on a pita-style bun.',
    price: 17.99,
    image: 'https://images.pexels.com/photos/4253320/pexels-photo-4253320.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    category: 'burger',
  },
  {
    id: 15,
    name: 'Hawaiian Teriyaki',
    description: 'Grilled pineapple, teriyaki-glazed beef patty, Swiss cheese, and wasabi mayo on a Hawaiian sweet roll.',
    price: 15.99,
    image: 'https://images.pexels.com/photos/3738730/pexels-photo-3738730.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    category: 'burger',
  },
  {
    id: 16,
    name: 'Artisanal Lemonade',
    description: 'Fresh-squeezed lemonade infused with seasonal fruits and herbs.',
    price: 4.99,
  ...
  },
  {
    ...
    description: 'Smooth, house-made cold brew coffee served over ice with your choice of flavoring.',
    price: 4.49,
  ...
  },
  {
    ...
    description: 'Classic New York-style cheesecake with a graham cracker crust and seasonal berry compote.',
    price: 7.99,
  ...
  },
  {
    id: 20,
    name: 'Apple Crumble',
    description: 'Warm cinnamon-spiced apples topped with oat streusel and served with caramel sauce.',
    price: 7.49,
